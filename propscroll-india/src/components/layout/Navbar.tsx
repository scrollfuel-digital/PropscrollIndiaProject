...
import {
  Menu, X, Heart, GraduationCap, MapPin, ChevronDown, Phone,
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-2.5">
              ...
              <button
                onClick={() => go("/contact")}
                className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl font-black text-[12px] uppercase tracking-[0.06em] border-none cursor-pointer text-white bg-gradient-to-br from-[#008C99] to-[#006e78] transition-all duration-200 hover:-translate-y-px hover:shadow-[0_6px_20px_rgba(0,140,153,0.35)]"
              >
            ...
            <div className="hidden md:flex lg:hidden items-center gap-2">
              ...
              <button
                onClick={() => go("/contact")}
                className="flex items-center gap-1 px-3 py-2 rounded-xl font-black text-[11px] uppercase tracking-[0.05em] border-none cursor-pointer text-white bg-gradient-to-br from-[#008C99] to-[#006e78]"
              >
                <Phone size={13} />
                <span>Contact</span>
              </button>
      ...
      {isOpen && (
        <div className="anim-mob fixed top-[56px] md:top-[52px] lg:top-[60px] left-0 right-0 w-full bg-white border-t border-slate-200 max-h-[84vh] overflow-y-auto z-[9998] shadow-[0_20px_40px_rgba(0,0,0,0.11)]">
          <div className="p-3.5 flex flex-col gap-2">
            ...
            <button
              onClick={() => go("/contact")}
              className="flex items-center justify-center gap-2 p-[15px] rounded-[14px] bg-gradient-to-br from-[#008C99] to-[#006e78] text-white font-black text-[13px] uppercase tracking-[0.07em] border-none cursor-pointer"
            >
              <Phone size={16} />
              <span>Contact Us</span>
            </button>
