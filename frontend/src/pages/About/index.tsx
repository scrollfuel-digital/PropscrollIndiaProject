  ...
  const team = [
    {
      name: "Smiit Pillewar",
      role: "Founder & CEO",
      exp: "9+ yrs of Experiance in Real Estate",
      img: "/smit.jpg",
    },
    {
      name: "Mona Pillewar",
      role: "Co-founder & MD",
      exp: "6+ yrs of Experiance in Real Estate",
      img: "/monamaam.jpeg",
    },
  ];
  ...
  return (
    <div className="min-h-screen font-sans bg-white text-[#0F2540]">
      ...
      <section
        ...
        style={{
          background: `linear-gradient(135deg, ${COLORS.NAVY} 0%, #1a3a5c 60%, #1e4976 100%)`,
        }}
      >
        <div
          className="absolute -top-20 -right-20 w-80 h-80 rounded-full opacity-[0.08]"
          style={{ background: COLORS.MUSTARD }}
        />
        <div
          className="absolute -bottom-16 -left-16 w-60 h-60 rounded-full opacity-[0.12]"
          style={{ background: COLORS.TEAL }}
        />
        <div
          className="absolute top-0 left-0 right-0 h-[5px]"
          style={{
            background: `linear-gradient(90deg, ${COLORS.RED} 0%, ${COLORS.MUSTARD} 50%, ${COLORS.TEAL} 100%)`,
          }}
        />

        <div className="relative z-10 max-w-[860px] mx-auto text-center">
          <span
            className="inline-block px-[18px] py-[5px] rounded-full text-[11px] font-bold tracking-[0.1em] uppercase"
            style={{
              background: "rgba(252,192,46,0.18)",
              color: COLORS.MUSTARD,
              border: "1px solid rgba(252,192,46,0.4)",
            }}
          >
            Maharashtra's Trusted Real Estate Partner
          </span>
          <h1
            className="font-extrabold text-white leading-[1.08] tracking-tight my-6"
          ...
          <p className="text-[rgba(255,255,255,0.72)] text-lg max-w-[580px] mx-auto leading-[1.65]">
            A tech-driven, end-to-end real estate solutions company serving
            buyers, sellers, developers, and investors across all 36 districts
            of Maharashtra — from village plots to metro skyscrapers.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white border-b border-gray-100 px-6 py-10 shadow-[0_4px_16px_rgba(15,37,64,0.06)]">
        <div className="max-w-[1100px] mx-auto grid grid-cols-[repeat(auto-fit,minmax(140px,1fr))] gap-6 text-center">
          {stats.map((s, i) => (
            <div
              key={i}
              className="pt-3 border-t-[3px]"
              style={{ borderColor: COLORS.MUSTARD }}
            >
              <p className="text-3xl font-extrabold text-[#0F2540]">
                {s.value}
              </p>
              <p className="text-[11px] text-gray-500 mt-1 font-semibold tracking-[0.04em] uppercase">
                {s.label}
              </p>
            </div>
          ))}
      ...
      <section className="px-6 py-24 bg-white">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-[11px] font-bold tracking-[0.12em] uppercase text-[#008C99] mb-2">
              Who We Are
            </p>
            <h2
              className="font-extrabold text-[#0F2540] leading-[1.15] mb-5"
              style={{ fontSize: "clamp(28px, 3.5vw, 40px)" }}
            >
              Maharashtra's Most Complete
              <br />
              Real Estate Platform
            </h2>
            <p className="text-gray-600 leading-[1.75] mb-4 text-[15px]">
              PropScrollIndia Real Estate Global Mall is a B2B + B2C real estate
              solutions provider covering the entire state of Maharashtra — from
              remote villages to tier-1 metro cities like Mumbai, Pune, Nashik,
              and Nagpur.
            </p>
            <p className="text-gray-600 leading-[1.75] mb-7 text-[15px]">
              We operate across six core verticals: property buying & selling,
              government liaisoning & approvals, joint venture structuring,
              project marketing, exclusive sales management, and investment
              advisory — all powered by proprietary PropTech CRM and an AI-based
              pricing engine.
            </p>
            <div className="flex flex-wrap gap-2.5">
              {[
                ...
                <span
                  key={tag}
                  className="inline-block px-[14px] py-[5px] rounded-full text-[11px] font-bold tracking-[0.04em] uppercase border-2"
          ...
          <div
            className="relative overflow-hidden rounded-3xl p-9 text-white"
            style={{ background: COLORS.NAVY }}
          >
            <div
              className="absolute -top-10 -right-10 w-40 h-40 rounded-full opacity-[0.15]"
              style={{ background: COLORS.TEAL }}
            />
            <p
              className="text-[11px] font-bold tracking-[0.1em] uppercase mb-7"
                ...
                <div key={i}>
                  ...
                  <div className="h-1.5 rounded-full overflow-hidden bg-white/10">
                    <div
                      ...
                      style={{
                        width: `${item.pct}%`,
                        background: `linear-gradient(90deg, ${COLORS.TEAL}, ${COLORS.MUSTARD})`,
                      }}
                    />
                  </div>
                </div>
      ...
      <section className="px-6 py-24 bg-gray-100">
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-14">
            ...
            <h2
              className="font-extrabold text-[#0F2540]"
              style={{ fontSize: "clamp(28px, 3.5vw, 40px)" }}
            >
              Our Core Values
            </h2>
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6">
            {values.map((v, i) => (
              ...
              >
                ...
                <h3 className="text-[17px] font-extrabold text-[#0F2540] mb-2.5">
                  {v.title}
                </h3>
      ...
      <section className="px-6 py-24 bg-white">
        <div className="max-w-[680px] mx-auto">
          ...
          <div className="relative pl-10">
            <div
              className="absolute left-[14px] top-0 bottom-0 w-0.5 opacity-30"
              style={{
                background: `linear-gradient(to bottom, ${COLORS.TEAL}, ${COLORS.MUSTARD})`,
              }}
            />
                    ...
                    style={{
                      background:
                        i === milestones.length - 1
                          ? COLORS.MUSTARD
                          : COLORS.TEAL,
                      boxShadow: `0 0 0 3px ${i === milestones.length - 1 ? COLORS.MUSTARD : COLORS.TEAL}33`,
                    }}
                  />
                  <div
                    ...
                    style={{
                      background:
                        i === milestones.length - 1 ? COLORS.NAVY : COLORS.GRAY,
                      color:
                        i === milestones.length - 1
                          ? COLORS.MUSTARD
                          : COLORS.NAVY,
      ...
      <section className="px-6 py-24" style={{ background: COLORS.NAVY }}>
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-14">
            <span
              className="inline-block w-9 h-1 rounded mb-3"
              style={{ background: COLORS.MUSTARD }}
            />
            <p
            ...
            {team.map((t, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(160deg,#1a3a5c,#0F2540)",
                  }}
                >
                  <img
                    src={t.img}
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to top, rgba(15,37,64,0.9), transparent)",
                    }}
                  />
                </div>
                ...
                <div className="px-6 py-5">
                  <h3 className="font-extrabold text-white text-[17px] mb-1">
                    {t.name}
                  </h3>
                  <p
